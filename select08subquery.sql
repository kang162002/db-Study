...
--          NOT IN 으로 할시 포항에 다니지 않는사람들만 분류             
                  from dept2
...
-- 학생들 중에 학번이 9513 학생보다 키가작은 학생들 조회                        
select *
from student;
...
--자신과 같은 고용형태(emp_type)의 편균 급여보다 적게 받는 직원 목록 조회
...
select AVG(pay) AVG(pay) avg_pay
    from emp2
    group by emp_type; 
