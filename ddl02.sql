...
NUMBER(자리수)
NUMBER(전체자리스, 소수점자리수)
NUMBER(6,3) 전체6자리, 소수점 3자리 123.456 O / 1234.56 X
NUMBER 라고만 표기 : 38자리 까지 가능
...
INSERT INTO tt02
VALUES (1, 'name1', SYSDATE, 60, 'Y'); --중복 NUIQUE 제약

INSERT INTO tt02
VALUES (2, null, SYSDATE, 60, 'Y'); -- 이름 NOT NULL제약

INSERT INTO tt02
VALUES (2, 'name2', SYSDATE, 850, 'Y'); --score 점수 범위 제약 (0~100)

INSERT INTO tt02
VALUES (2, 'name2', SYSDATE, 70, 'Q'); --pass 가능 범위 제약 ('Y', 'N')
